...
////////////////////////////////////////////////////////////////////
//-----------------LCD端口定义---------------- 
#define	LCD_LED PCout(12) 				 //LCD背光    	PC10 
 
#define	LCD_CS_SET  GPIOC->BSRR=1<<9     //片选端口  		PC9
#define	LCD_RS_SET	GPIOC->BSRR=1<<8     //数据/命令 		PC8	   
#define	LCD_WR_SET	GPIOC->BSRR=1<<10    //写数据			PC7
#define	LCD_RD_SET	GPIOC->BSRR=1<<11    //读数据			PC6
								    
#define	LCD_CS_CLR  GPIOC->BRR=1<<9      //片选端口  		PC9
#define	LCD_RS_CLR	GPIOC->BRR=1<<8      //数据/命令		PC8	   
#define	LCD_WR_CLR	GPIOC->BRR=1<<10     //写数据			PC7
#define	LCD_RD_CLR	GPIOC->BRR=1<<11     //读数据			PC6   
...
#else
//PC0~7?PB8~15,?????
void DATAOUT(u16 x);// {GPIOB->ODR |=x;}//数据输出
/*
#define DATAOUT(x)\
	GPIOC->ODR&=0XFF00;\
	GPIOB->ODR&=0X00FF;\
	...
	GPIOB->ODR|=x&0xFF00;
*/
#define DATAIN 		(GPIOC->IDR & 0x00FF)|(GPIOB->IDR & 0xFF00);
#endif
